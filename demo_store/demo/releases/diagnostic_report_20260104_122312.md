...
1. `docker info`
2. `cd /home/bazari/generated/_failed/DOCKER_UP_FAILED/demo_20260104_122312 && docker compose build`
3. `lsof -i :5432 -i :8080 -i :3000`
4. `cd /home/bazari/generated/_failed/DOCKER_UP_FAILED/demo_20260104_122312 && docker compose logs --tail=100`
5. `docker compose ps`
...
```
REPO PRESERVADO EM:
  /home/bazari/generated/_failed/DOCKER_UP_FAILED/demo_20260104_122312
```
...
- docker compose up failed:  demo-backend  Built
 Network demo_default  Creating
 Network demo_default  Created
 Volume "demo_postgres_data"  Creating
 Volume "demo_postgres_data"  Created
...
*Timestamp: 2026-01-04T12:23:12.783240*